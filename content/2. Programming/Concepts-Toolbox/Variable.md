...
---
## Notes and Info
- A variable is a named piece of your computer's memory. 
...
### Examples
```java
// Declaration only, no modifiers
int myNumber;

// Declaration only, with modifiers
private String myString;

// Declaration and Assignment, no modifiers
float myFloat = 3.14f;

// Declaration and Assignment, with modifiers
public char myChar = 'y';
```
